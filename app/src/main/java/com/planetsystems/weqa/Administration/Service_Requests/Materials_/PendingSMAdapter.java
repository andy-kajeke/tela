...
import com.planetsystems.weqa.Administration.School_Updates.Edit_TimeTable.TimetableModel;
import com.planetsystems.weqa.R;

import java.util.ArrayList;

public class PendingSMAdapter extends ArrayAdapter<SchoolMaterialModel> {
    ArrayList<SchoolMaterialModel> proList;
    LayoutInflater vi;
    int Resource;
    ViewHolder holder;

    public PendingSMAdapter(Context context, int resource, ArrayList<SchoolMaterialModel> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.description.setText(proList.get(position).getItemName());
