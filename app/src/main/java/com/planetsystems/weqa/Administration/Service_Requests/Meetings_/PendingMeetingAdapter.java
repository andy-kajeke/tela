...
public class PendingMeetingAdapter extends ArrayAdapter<MeetingModel> {
    ArrayList<MeetingModel> proList;
    LayoutInflater vi;
    int Resource;
    ViewHolder holder;

    public PendingMeetingAdapter(Context context, int resource, ArrayList<MeetingModel> objects) {
