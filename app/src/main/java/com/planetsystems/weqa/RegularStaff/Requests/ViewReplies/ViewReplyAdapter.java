...
public class ViewReplyAdapter extends ArrayAdapter<SchoolMaterialModel> {
    ArrayList<SchoolMaterialModel> proList;
    LayoutInflater vi;
    int Resource;
    ViewHolder holder;

    public ViewReplyAdapter(Context context, int resource, ArrayList<SchoolMaterialModel> objects) {
