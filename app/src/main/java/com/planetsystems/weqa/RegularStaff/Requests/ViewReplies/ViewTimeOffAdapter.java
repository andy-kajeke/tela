...
public class ViewTimeOffAdapter extends ArrayAdapter<TimeOffModel> {
    ArrayList<TimeOffModel> proList;
    LayoutInflater vi;
    int Resource;
    ViewHolder holder;

    public ViewTimeOffAdapter(Context context, int resource, ArrayList<TimeOffModel> objects) {
