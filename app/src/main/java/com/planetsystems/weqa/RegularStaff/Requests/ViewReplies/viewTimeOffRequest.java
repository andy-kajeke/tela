...
public class viewTimeOffRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_time_off);
        ...
        adapter= new ViewTimeOffAdapter(getApplicationContext(),R.layout.view_replies, markList);
    ...
    private void DisplayLeaveRequest() {
        ...
        try {
            ...
            cursor = db.rawQuery("select * from SyncEmployeeTimeOffRequestDMs WHERE deploymentSiteId = " + "'"+school_id_extra+"'"
                    + " AND employeeId = " + "'"+id_extra+"'" + " AND employeeRequestType = " + "'"+TimeOff+"'"
